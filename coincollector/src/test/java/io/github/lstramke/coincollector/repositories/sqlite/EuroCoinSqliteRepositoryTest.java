...
class EuroCoinSqliteRepositoryTest {
    ...
    record ExistsTestCase(String coinId, boolean resultSetHasNext, boolean expectedResult,
            boolean expectedOptionalIsPresent, boolean shouldThrowSQLException,
            String description) {
        @Override
    ...
    record ValidationTestCase(String coinId, Integer year, CoinValue coinValue,
            CoinCountry mintCountry, Mint mint, String collectionId, boolean expectedResult,
